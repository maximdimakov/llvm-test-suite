...
int main() {
  ...
  test<class KernelName_SljjtroxNRaAXoVnT>(q, input, output, ONEAPI::bit_or<int>(), 0);
  test<class KernelName_yXIZfjwjxQGiPeQAnc>(q, input, output, ONEAPI::bit_xor<int>(),
                                            0);
  test<class KernelName_xGnAnMYHvqekCk>(q, input, output, ONEAPI::bit_and<int>(), ~0);
#endif // SPIRV_1_3
